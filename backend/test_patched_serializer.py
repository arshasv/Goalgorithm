...
# Patch goal_scorers manually to strings
serializer_payload["match_prediction"]["goal_scorers"]["home"] = ["Folarin Balogun"]
serializer_payload["match_prediction"]["goal_scorers"]["away"] = ["Bosnia and Herzegovina Forward 1"]
