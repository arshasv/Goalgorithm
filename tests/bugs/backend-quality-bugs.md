# Backend Quality - Bugs Log

## Bug BUG-BA-001
- **Status**: FIXED
- **Severity**: HIGH
- **Category**: Backend Architecture / Clean Architecture Violation
...
- **Issue Description**: Direct database access exists inside route handlers.
